...
export function DemoBanner({ spaceId }: { spaceId: string }) {
  ...
  return (
    <div
      className="flex items-center justify-between gap-4 px-6 py-2.5 text-[0.8rem] md:px-8"
      style={{
        background:
    ...
    >
      ...
      >
        ...
        <button
          type="submit"
          disabled={isPending}
          className="whitespace-nowrap rounded-xl border border-warm-3/20 bg-warm-3/8 px-3.5 py-1 text-[0.75rem] font-medium text-warm-3 transition-all hover:border-warm-3/40 hover:bg-warm-3/15 disabled:opacity-50"
        >
